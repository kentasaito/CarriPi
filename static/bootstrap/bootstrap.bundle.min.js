...
!function (t, e) {
  ...
  const t = new Map(),
    e = {
      set(e, i, n) {
        ...
        const s = t.get(e);
        s.has(i) || 0 === s.size ? s.set(i, n) : console.error(
    ...
    i = "transitionend",
    n = (t) => (t && window.CSS && window.CSS.escape &&
  ...
  class xt extends W {
    ...
    _addEventListeners() {
      this._config.keyboard && N.on(this._element, ft, (t) => this._keydown(t)),
        ...
        this._config.touch && st.isSupported() &&
  ...
  const je = {
    ...
    effect: function (t) {
      ...
      null != n &&
        ...
        Oe(e.elements.popper, n) && (e.elements.arrow = n);
    },
  ...
  function We(t) {
    ...
    if (c) {
      ...
      A === fe(i) && "static" !== xe(A = Le(i)).position && "absolute" === a &&
      (E = "scrollHeight", T = "scrollWidth"),
        (s === zt || (s === Vt || s === qt) && o === Yt) &&
        (y = Rt,
          m -= (d && A === w && w.visualViewport
    ...
    var i = e,
      ...
      w = function (t, e, i, n) {
        var s = "clippingParents" === e
            ? function (t) {
              var e = Je(Se(t)),
                i = ["absolute", "fixed"].indexOf(xe(t).position) >= 0 && me(t)
                  ? $e(t)
                  : t;
              return pe(i)
                ? e.filter(function (t) {
  ...
  class qi extends W {
    constructor(t, e) {
      super(t, e),
        ...
        this._menu = z.next(this._element, Pi)[0] ||
          z.prev(this._element, Pi)[0] || z.findOne(Pi, this._parent),
    ...
    static dataApiKeydownHandler(t) {
      ...
      const s = this.matches(Ii)
          ? this
          : z.prev(this, Ii)[0] || z.next(this, Ii)[0] ||
  ...
  class On extends W {
    ...
    _triggerBackdropTransition() {
      ...
      "hidden" === e || this._element.classList.contains(En) ||
        ...
        if ("click" === e) {
          ...
          N.on(this._element, t, this._config.selector, (t) => {
            ...
            N.on(this._element, i, this._config.selector, (t) => {
              const e = this._initializeOnDelegatedTarget(t);
              e._activeTrigger["focusout" === t.type ? os : ss] = e._element
  ...
  class Es extends W {
    ...
    _activateParents(t) {
      ...
      } else {for (const e of z.parents(t, ".nav, .list-group")) {
  ...
  const Ts = ".bs.tab",
    ...
    Vs =
      `.${Fs}[data-bs-toggle="tab"], .${Fs}[data-bs-toggle="pill"], .${Fs}[data-bs-toggle="list"]`;
  class Ks extends W {
    constructor(t) {
      super(t),
